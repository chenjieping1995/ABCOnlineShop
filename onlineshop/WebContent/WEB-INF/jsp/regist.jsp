		...
		<div class="span5">
			<div class="logo">
				<a href="http://localhost:8080/mango/"> <img
					src="${pageContext.request.contextPath}/image/r___________renleipic_01/abclogo.jpg" height="45" width="225" alt="ABC"></a>
			</div>
		</div>
		<div class="span9">
			<div class="headerAd">
							...
							<tbody>
								<tr>
									...
									<td><input type="text" id="username" name="username"
										class="text" maxlength="20" onblur="checkUsername()" /> <!-- 用于输出的span -->
