...
<body>
		...
		<div class="span5">
			<div class="logo">
				<a href="./网上商城/index.htm"> <img
					src="${pageContext.request.contextPath}/image/r___________renleipic_01/abclogo.jpg" height="45" width="225" alt="ABC"/>
				</a>
			</div>
		</div>
		<div class="span9">
						...
						<tr>
							<th colspan="5">订单编号:<s:property value="#order.oid" />&nbsp;&nbsp;&nbsp;&nbsp;订单金额:<font
								...
								&nbsp;&nbsp;&nbsp;&nbsp;<font color="red"> <s:if
										test="#order.state == 1">
										<a
											href="${ pageContext.request.contextPath }/order_findByOid.action?oid=<s:property value="#order.oid" />">去付款</a>
	...
	<div class="container footer">
		...
		<div class="span24">
			<div class="copyright">Copyright © ABC在线商城 版权所有</div>
		</div>
	</div>
</body>
</html>