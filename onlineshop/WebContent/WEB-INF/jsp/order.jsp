...
<body>
		...
		<div class="span5">
			<div class="logo">
				<a href="./网上商城/index.htm"> <img
					src="${pageContext.request.contextPath}/image/r___________renleipic_01/abclogo.jpg"
					height="45" width="225" alt="ABC" />
				</a>
			</div>
		</div>
		<div class="span9">
	...
	<div class="container cart">
		...
		<div class="span24">
			...
			<form id="orderForm"
				action="${ pageContext.request.contextPath }/order_callBack.action"
				method="post">
